...
class Bot extends EventEmitter {
  constructor (opts) {
    ...
    this.graph_url = opts.graph_url ? opts.graph_url : 'https://graph.facebook.com/v5.0/'
  ...
  getProfile (id, cb) {
    return request({
      ...
      qs: this._getQs({fields: 'id,first_name,last_name,middle_name,name,name_format,picture,short_name,email'}),
      json: true
    })
      .then(body => {
